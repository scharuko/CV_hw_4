#!/usr/bin/env python3
# the code utilizes the demo in the luxonis github repository - THe code runs a mobile net ssd model on the depthai camera
# and shows depthmap and bounding boxes on the screen.
# This solution provided by the luxonis team is used as a base for the project
import atexit
import signal
import sys
